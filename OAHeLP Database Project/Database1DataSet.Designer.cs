...
namespace OAHeLP_Database_Project {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row AddTable1Row(string Name, short Age) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public short Age {
                get {
                    return ((short)(this[this.tableTable1.AgeColumn]));
                }
                set {
...
namespace OAHeLP_Database_Project.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table1] ([Name], [Age]) VALUES (@Name, @Age);\r\nSELECT Id, Name" +
                ", Age FROM Table1 WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table1] SET [Name] = @Name, [Age] = @Age WHERE (([Id] = @Original_I" +
                "d) AND ([Name] = @Original_Name) AND ([Age] = @Original_Age));\r\nSELECT Id, Name," +
                " Age FROM Table1 WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::OAHeLP_Database_Project.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Age FROM dbo.Table1";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Name, Age FROM dbo.Table1";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, short Original_Age) {
        ...
        public virtual int Insert(string Name, short Age) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((short)(Age));
        ...
        public virtual int Update(string Name, short Age, int Original_Id, string Original_Name, short Original_Age, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((short)(Age));
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((short)(Original_Age));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, short Age, int Original_Id, string Original_Name, short Original_Age) {
